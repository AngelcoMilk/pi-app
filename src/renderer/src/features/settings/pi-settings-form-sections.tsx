...
export function PiSettingsFormSections({
  ...
  return (
    <>
      <SettingsSection title={t('settings:pi.sectionModelInference')}>
        <SettingRow label={t('settings:pi.defaultModel')} description={t('settings:pi.defaultModelDesc')}>
          <select
        ...
        <SettingRow label={t('settings:pi.defaultThinking')} description={t('settings:pi.defaultThinkingDesc')}>
          <select
            className={selectCls}
        ...
        <SettingRow label={t('settings:pi.modelWhitelist')} description={t('settings:pi.modelWhitelistDesc')}>
          <input
        ...
        <SettingRow label={t('settings:pi.hideThinking')} description={t('settings:pi.hideThinkingDesc')}>
          <Toggle on={!!ui?.hideThinkingBlock} disabled={!ui} onChange={(v) => queuePatch({ hideThinkingBlock: v })} />
        </SettingRow>
      </SettingsSection>

      <SettingsSection title={t('settings:pi.sectionQueueTransport')}>
        <SettingRow label={t('settings:pi.steeringMode')} description={t('settings:pi.steeringModeDesc')}>
          <select
            className={selectCls}
        ...
        <SettingRow label={t('settings:pi.followUpMode')} description={t('settings:pi.followUpModeDesc')}>
          <select
            className={selectCls}
        ...
        <SettingRow label={t('settings:pi.transport')} description={t('settings:pi.transportDesc')}>
          <select
            className={selectCls}
      ...
      <SettingsSection title={t('settings:pi.sectionCompactionRetry')}>
        <SettingRow label={t('settings:pi.autoCompaction')} description={t('settings:pi.autoCompactionDesc')}>
          <Toggle
        ...
        <SettingRow label={t('settings:pi.compactionReserve')} description={t('settings:pi.compactionReserveDesc')}>
          <input
            type="number"
        ...
        <SettingRow label={t('settings:pi.compactionKeep')} description={t('settings:pi.compactionKeepDesc')}>
          <input
            type="number"
            className={cn(inputCls, 'max-w-[9rem]')}
            disabled={!ui}
        ...
        <SettingRow label={t('settings:pi.retryEnabled')} description={t('settings:pi.retryEnabledDesc')}>
          <Toggle on={ui?.retryEnabled !== false} disabled={!ui} onChange={(v) => queuePatch({ retryEnabled: v })} />
        </SettingRow>
        <SettingRow label={t('settings:pi.retryParams')} description={t('settings:pi.retryParamsDesc')}>
          <span className="font-mono text-xs text-muted-foreground">
            {t('settings:pi.retryParamsValue', { max: String(ui?.retryMaxRetries), delay: String(ui?.retryBaseDelayMs) })}
          </span>
        </SettingRow>
        <SettingRow label={t('settings:pi.branchSummary')} description={t('settings:pi.branchSummaryDesc')}>
          <span className="font-mono text-xs text-muted-foreground">
      ...
      <SettingsSection title={t('settings:pi.sectionToolShell')}>
        <SettingRow label={t('settings:pi.shellPath')} description={t('settings:pi.shellPathDesc')}>
          <input
            className={cn(inputCls, 'max-w-xs')}
            disabled={!ui}
        ...
        <SettingRow label={t('settings:pi.shellPrefix')} description={t('settings:pi.shellPrefixDesc')}>
          <input
            className={cn(inputCls, 'max-w-xs')}
            disabled={!ui}
        ...
        <SettingRow label={t('settings:pi.npmCommand')} description={t('settings:pi.npmCommandDesc')}>
          <input
            className={cn(inputCls, 'max-w-xs')}
            disabled={!ui}
            key={`npm-${formEpoch}`}
        ...
        <SettingRow label={t('settings:pi.imageAutoResize')} description={t('settings:pi.imageAutoResizeDesc')}>
          <Toggle on={!!ui?.imageAutoResize} disabled={!ui} onChange={(v) => queuePatch({ imageAutoResize: v })} />
        </SettingRow>
        <SettingRow label={t('settings:pi.showImages')} description={t('settings:pi.showImagesDesc')}>
          <Toggle on={ui?.showImages !== false} disabled={!ui} onChange={(v) => queuePatch({ showImages: v })} />
        </SettingRow>
        <SettingRow label={t('settings:pi.blockImages')} description={t('settings:pi.blockImagesDesc')}>
          <Toggle on={!!ui?.blockImages} disabled={!ui} onChange={(v) => queuePatch({ blockImages: v })} />
        </SettingRow>
      </SettingsSection>

      <SettingsSection title={t('settings:pi.sectionSkillStartup')}>
        <SettingRow label={t('settings:pi.defaultProjectTrust')} description={t('settings:pi.defaultProjectTrustDesc')}>
          <select
            className={selectCls}
        ...
        <SettingRow label={t('settings:pi.skillCommands')} description={t('settings:pi.skillCommandsDesc')}>
          <Toggle
        ...
        <SettingRow label={t('settings:pi.quietStartup')} description={t('settings:pi.quietStartupDesc')}>
